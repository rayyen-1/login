...
void cari() {
    ...
    do {
        ...
        // Kata kunci & nama produk sama-sama dijadikan huruf kecil supaya
        // pencarian tidak case-sensitive dan bisa mengenali sebagian kata
        string kataKunciLower = kataKunci;
        for (size_t k = 0; k < kataKunciLower.size(); k++) {
            kataKunciLower[k] = tolower(kataKunciLower[k]);
        }

        system("cls"); // refresh layar, tampilkan tabel hasil pencarian
